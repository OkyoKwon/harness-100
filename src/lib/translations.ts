...
const translations: Record<string, TranslationEntry> = {
  ...
  "builder.getStarted": { ko: "시작하기", en: "Get Started" },
  "builder.getStartedDesc": { ko: "템플릿으로 빠르게 시작하거나 처음부터 만드세요", en: "Quick-start with a template or build from scratch" },
  "builder.startFromScratch": { ko: "처음부터 만들기", en: "Start from Scratch" },
  "builder.or": { ko: "또는", en: "or" },
  "builder.template.prReview.name": { ko: "PR 리뷰 자동화", en: "PR Review Automation" },
  "builder.template.prReview.desc": { ko: "코드 품질, 테스트, 보안을 자동으로 리뷰", en: "Auto-review code quality, tests, and security" },
  "builder.template.docGen.name": { ko: "문서 생성기", en: "Documentation Generator" },
  "builder.template.docGen.desc": { ko: "README, API 문서, 가이드를 자동 생성", en: "Auto-generate README, API docs, and guides" },
  "builder.template.fullstack.name": { ko: "풀스택 웹앱", en: "Full-stack Web App" },
  "builder.template.fullstack.desc": { ko: "설계부터 리뷰까지 웹앱 개발 전 과정", en: "End-to-end web app development pipeline" },
  "builder.template.security.name": { ko: "보안 감사", en: "Security Audit" },
  "builder.template.security.desc": { ko: "OWASP Top 10 기반 보안 취약점 분석", en: "OWASP Top 10 vulnerability analysis" },
  "builder.feature.aiAssist": { ko: "AI 어시스트", en: "AI Assist" },
  "builder.feature.multiAgent": { ko: "멀티 에이전트", en: "Multi-Agent" },
  "builder.feature.exportReady": { ko: "바로 내보내기", en: "Export Ready" },
