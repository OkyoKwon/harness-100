...
const translations: Record<string, TranslationEntry> = {
  ...
  "builder.skill.markdown": { ko: "스킬 (skill.md)", en: "Skill (skill.md)" },
  ...
  "builder.skill.aiGenerating": { ko: "AI 작성 중입니다. 완료될 때까지 잠시 기다려주세요.", en: "AI is generating. Please wait..." },
  "builder.skill.generatingSkillDetails": { ko: "스킬 이름과 트리거 조건을 생성하고 있습니다...", en: "Generating skill name and trigger conditions..." },
  "builder.skill.generatingExtSuggestions": { ko: "확장 스킬을 분석하고 있습니다...", en: "Analyzing extension skills..." },
  "builder.skill.generatingExtMarkdown": { ko: "확장 스킬 생성 중 ({current}/{total}) — {name}", en: "Generating extension skill ({current}/{total}) — {name}" },
  ...
  "builder.skill.generateExtensions": { ko: "확장 스킬 생성", en: "Generate Extensions" },
  "builder.skill.generatingExtAll": { ko: "생성 중 ({current}/{total})", en: "Generating ({current}/{total})" },
